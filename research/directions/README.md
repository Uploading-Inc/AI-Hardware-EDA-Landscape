...
| Repository-scale RTL | Can an agent locate and repair a real bug within a complete hardware project? | Issue description, repository, build environment, and tests | One- or multi-file repository patch | Long-horizon search, editing, shell use, and test feedback |
...
| Repository-scale RTL | Fail-to-pass native project verification; resolved-task rate | [HWE-Bench-Repair](../benchmarks/hwe-bench-repair.md); coding agents with repository and shell access |
...
| Repository-scale RTL | Repair under real project context and executable regressions | Correctness beyond reconstructed tests or general hardware-product engineering | Growing realistic task family; leakage, commercial dependencies, and environment longevity remain risks |
